/*
 * I re-copied this because of the different definitions for the
 * various platforms.
 * Some people seem to not recognize that KDE runs on other OS besides
 * Linux.
 * However, I removed the warning so nobody gets bothered by this one.
 *
 * Please, PLEASE: If you have a problem with _this_ file: Just edit the
 * offending line and don't create a new one.
 *
*/
